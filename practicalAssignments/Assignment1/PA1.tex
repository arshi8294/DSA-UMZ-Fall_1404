...
\begin{itemize}[rightmargin=1cm, leftmargin=3cm]
    ...
    \item روز ارائه‌ی تمرین عملی با هماهنگی در گروه تلگرامی درس اعلام خواهد شد.
\end{itemize}
\end{flushright}
...
\begin{itemize}[rightmargin=1cm, leftmargin=3cm]
    ...
    \item \href{https://github.com/arshi8294/DSA-UMZ-Fall_1404/tree/master/practicalAssignments/Assignment1}{لینک گیت‌هاب}
\end{itemize}
\end{flushright}
...
*دقت شود که مانند مرورگر های واقعی در صورت \lr{visit}جدید تاریخچه فرواردها پاک می‌شود. 
...
\begin{flushleft}
    ...
    \lr{students = [1,1,1,0,0,1], sandwiches = [1,0,0,0,1,1]}
...
\begin{flushleft}
    ...
    \lr{3}
\end{flushleft}
* دقت شود در مثال های بالا پشته پیاده سازی نشده و در واقع ایندکس 0 ام لیست ساندویچ ها بالای پشته است.
...
\vspace*{0.5\baselineskip}
\textbf{راهنمایی:}   از یک پشته برای نگهداری روزها استفاده کنید.
\end{questions}
